...
<div class="container mt-5 w-100">
    <div class="row">
          ...
          <div class="col">
            ...
            <?php var_dump($noticia_editar);
              ...
              <div class='form-group w-100'>
                ...
                }else if($noticia_editar->img_url == 2){
                  $imagen = array(
          ...
          <div class="col">
            <div class="form-check">
              <?php 
                ...
                $cc_autor_input = array('name'=>'cc_autor', 'value' => $noticia_editar->cc_autor, 'class'=> 'mb-4 form-control'); 
                echo form_input($cc_autor_input);
                echo form_label('FECHA', 'FECHA'); 
                $fecha = explode(" ", $noticia_editar->fecha_publicacion);
                $fecha = $fecha[0];
                $fecha_input = array('name'=>'fecha', 'value' => $fecha , 'class'=> 'form-control mb-4', 'type' => 'date'); 
              ...
              <label class="form-check-label mx-4" for="flexRadioDefault1">
                SI
                <?php 
                  if($noticia_editar->validado==1){
                    $validado_input = array('name'=>'validado', 'value' => 1, 'class'=> 'form-check-input', 'type' => 'radio', 'checked' =>true); 
                    $validado1_input = array('name'=>'validado', 'value' =>0, 'class'=> 'form-check-input', 'type' => 'radio');
                  }else{
          ...
          <div class="mb-4">
                    ...
                    <?php 
                    $descripcion_input = array('name'=>'descripcion', 'value' => $noticia_editar->descripcion, 'type' => 'textarea', 'class'=>'form-control'); 
